...
It really helps if you write how you got scammed and maybe add some printscreens.
When you've filled all the fields, just go ahead and hit "Report" and then you're done.
Now all the users will get warned if that account adds you as friend!
/**/

As of today (5/9 2014), there is not many scammers reported.
...
The job-assignment we got were: Create an application that help in the war against crime :)
